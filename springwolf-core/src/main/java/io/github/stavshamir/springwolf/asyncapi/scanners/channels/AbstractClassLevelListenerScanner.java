...
public abstract class AbstractClassLevelListenerScanner<ClassAnnotation extends Annotation, MethodAnnotation extends Annotation> implements ChannelsScanner {
    ...
    private Optional<Map.Entry<String, ChannelItem>> mapClassToChannel(Class<?> component) {
        ...
        ChannelItem channelItem = buildChannel(annotatedMethods, channelBinding, operationBinding);
    ...
    private ChannelItem buildChannel(Set<Method> methods, Map<String, ? extends ChannelBinding> channelBinding, Map<String, ? extends OperationBinding> operationBinding) {
